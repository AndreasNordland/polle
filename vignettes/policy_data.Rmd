...
Consider a two-stage problem with observations $O = (B, BB, L_{1}, C_{1}, U_{1}, A_1, L_2, C_{2}, U_{2}, A_2, U_{3})$. Following the general notation introduced in the associated paper, $(B,BB)$ are the baseline covariates, $S_k =(L_{k, C_{k}})$ are the
...
processes with a stochastic number of stages.
