...
This vignette is a guide to `policy_learn()` and some of the associated S3 generic functions.
The purpose of `policy_learn` is to specify a policy learning algorithm and estimate an optimal
policy. For details on the methodology, see the associated paper on [arxiv](https://arxiv.org/abs/2212.02335).
...
For details on the implementation, see Algorithm 3 in the associated paper.
...
see Algorithm 5 in the associated paper. Here we set a 5\% restriction:
