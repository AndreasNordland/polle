...
## removed as a dependency of 'polle'. The original SuperLearner helper
## learners defined here (SL.glm.formula, SL.nls and their predict methods)
## are retained as commented source, so that a future polle release can
## revive them if a SuperLearner-based nuisance model interface is
## reintroduced. They are currently not exported and no code in polle
## references them.
##
